...
window.addEventListener("scroll",()=>{
	...
	sections.forEach(current=>{
		...
		if(scrollY>sectionTop && scrollY<=sectionTop+sectionHeight){
			document.querySelector(".navigation__items a[href*="+id+"]").classList.add("active");

		}
		else{
			document.querySelector(".navigation__items a[href*="+id+"]").classList.remove("active");
		}
	});
});
...
const navItems=document.querySelectorAll(".navigation__items a");
...
ScrollReveal().reveal('footer .group,.footer-copyright', {delay:400, origin:'top',interval:200});